...
public class TableManager {
    ...
    public void addReservation(Reservation reservation) {
        if (!getAvailableTables(reservation.getTime(), reservation.getPax()).contains(reservation.getTableId())) {
     ...
     * @return A list of reservations for a given time
     */
     ...
     * 
     * @param reservation the specific reservation to be removed.
     */
    ...
    /**
     * Prints table information according to the given time period.
     * 
     * @param time the time period for table availability
     */
    ...
    public void loadReservations() {
        try {
            String fileName = "restaurant\\database\\reservations.txt";
    ...
    public void loadTables() {
        try {
            String fileName = "restaurant\\database\\tables.txt";
            BufferedReader br = new BufferedReader(new FileReader(fileName));

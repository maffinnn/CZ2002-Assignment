...
/**
 * The category class is used in restaurant menu to represent each category in
 * the menu. The {@link Category} is a composite class to hold an array list of
 * menu items, be it {@link MenuLeaf} or {@link MenuBundle}.
 *
 * @author Zhou Yiqi
 * @author Bian Siyuan
...
public class Category implements MenuList {
    ...
    /**
     * Returns the number of children under a category.
     *
     * @return The number of children under a category.
     */
    @Override

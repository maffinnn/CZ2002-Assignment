 ...
 * represents a promotional items sold in bundle.
 *
 * @author Zhou Yiqi
 * @author Bian Siyuan
...
public class MenuBundle extends AbstractMenuItem implements MenuList {
     ...
     *
     * @param code        The code of a menu bundle
     * @param name        The name of a menu bundle
     * @param description The description of a menu bundle
     */
     ...
     *
     * @param mb the menu bundle to copy from
     */
    ...
    /**
     * Print a menu bundle item in a user-friendly format
     */
    @Override
    public void print() {
     ...
     * report
     * 
     * @param isInvoice boolean to check if this print function is called for
     *                  printing invoice
     */
    ...
    /**
     * Self-defined rule for checking the equivalence of two {@link MenuBundle}
     * objects
     * 
     * @return true if two {@link MenuBundle} objects are identical in name and

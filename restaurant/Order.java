...
public class Order implements MenuList, Comparable<Order> {
     ...
     * 
     * @param isMember boolean to check if this order is paid by a member of the
     *                 restaurant
     */
    ...
    /**
     * @return Returns the reservation assiocated with an order
     */
    ...
    /**
     * Self-defined rule for order comparasion according to the reservations
    ...
    /**
     * Self-defined rule for order comparasion according to which table this order
     * belongs to
     */
    @Override

...
public class RestaurantApp {
    ...
    private void runReservation() {
        ...
        do {
            ...
            case 1:
                ...
                break;
            case 2:
                System.out.println("Enter a choice(1. by time; 2. by contact): ");
    ...
    private void runOrder() {
        ...
        do {
            ...
            switch (op) {
            case 1: {
                System.out.print("Do you have a reservation? (1: Yes, 0: No)");
                int res = sc.getInt();
                if (res == 1) {
                    ...
                    if (t.size() != 0) {
                        ...
                        Reservation curReservation = t.get(index);
                        System.out.print("Enter your staffId: ");
                        int staffId = sc.getInt();
                        myRestaurant.makeOrder(staffId, curReservation);
            ...
            case 4:
                ...
                myRestaurant.removeActiveOrder(ooo);
                break;
            default:
                break;
            }
    ...
    /**
     * Check reservation according to the given time.
     *
     * @param time the requested time
     */
    private void checkReservation(LocalDateTime time) {
        ArrayList<Reservation> result = myRestaurant.getReservation(time);
        if (result.size() == 0) {
            System.out.println("This reservation does not exist");
        } else {
            displayReservation(result);

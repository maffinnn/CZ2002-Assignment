...
/**
 * database class bundles different systems in the database. The class itself
 * doesn't do a lot.
 *
 * @author owl
 * @author TODO
...
public class Restaurant {
    ...
    /**
     * database menu code to item look up talbe.
     */
    ...
    /**
     * database historical orders, used for sales report.
     */
    ...
    public void loadMenuReference() {
        try {
            String fileName = "database\\MenuReference.txt";
    ...
    private void loadMenu() {
        try {
            String fileName = "database\\Menu.txt";
    ...
    private void loadOrder() {
        try {
            String fileName = "database\\activeOrders.txt";
    ...
    private void saveOrder() {
        ...
        try {
            ...
            for (Order curOrder : inactiveOrders) {
                String filename = "database\\historyOrders\\" + curOrder.getReservation().getTime()
    ...
    public void loadHistoryOrders() {
        String pathName = "database\\historyOrders/";
